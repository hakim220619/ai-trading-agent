"""Train the XGBoost classifier from CSV candle data.
...
try:
    ...
    raise SystemExit(f"xgboost is required for training: {exc}")
...
def train(
    ...
    """Train and persist the model; return evaluation metrics."""
...
def _parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Train XGBoost trading model")
